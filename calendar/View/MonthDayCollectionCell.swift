...
final internal class MonthDayCollectionCell: UICollectionViewCell, CollectionReusable {
    typealias  MonthDayAnimationCompletion = (Bool) -> ()
    ...
    var dayLabelAlignment:  DayLabelAlignment = .left
    ...
    public func select(withAnimation animation:  SelectAnimation, completion:  MonthDayAnimationCompletion? = nil) {
        switch animation {
        case .none:
    ...
    public func deselect(withAnimation animation:  SelectAnimation, completion:  MonthDayAnimationCompletion? = nil) {
        switch animation {
        case .none:
    ...
    // - MARK: Animation None
    private func animationWithNone(_ isSelected: Bool, completion:  MonthDayAnimationCompletion?=nil) {
        if isSelected {
    ...
    private func animationWithBounce(_ isSelected: Bool, completion:  MonthDayAnimationCompletion?) {
    ...
    // - MARK: Animation Fade
    private func animationWithFade(_ isSelected: Bool, completion:  MonthDayAnimationCompletion?) {
